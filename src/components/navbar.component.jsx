...
const Navbar = () => {
    ...
    const [serachBoxVisibility, setSearchBoxVisisbility] = useState(false);
    ...
    <>
        <nav className="navbar">
            ...
            <div className={`absolute bg-white w-full left-0 top-full mt-0
             5 border-b border-grey py-4 px-[5vw] md:border-0 md:block
             md:relative md:inset-0 md:p-0 md:w-auto md:show ` + (
            ...
            <div className="flex items-center gap-3 md:gap-6 ml-auto">
                ...
                onClick={() => setSearchBoxVisisbility(currentVal => !currentVal)}
                >
